            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        tokenName = getSecureTokenName(((_a = record.factory) === null || _a === void 0 ? void 0 : _a.name) || ((_b = record.factory) === null || _b === void 0 ? void 0 : _b.__type__) || 'AnonymousFactory');
                    ...
                    case 2:
                        ...
                        if (duration > AsyncGovernance.SLOW_THRESHOLD && InstantiationPolicy.strictPerformance) {
                            (_d = (_c = InstantiationPolicy.logger) === null || _c === void 0 ? void 0 : _c.warn) === null || _d === void 0 ? void 0 : _d.call(_c, "[Performance Warning] Resolution for '".concat(tokenName, "' took ").concat(duration, "ms"));
                        }
