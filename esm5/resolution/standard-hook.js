...
export function onScopeCheck(definition, scope, context) {
    var _a;
    var hook = (_a = HookMetadata.get(definition.token)) === null || _a === void 0 ? void 0 : _a.onScopeCheck;
    if (hook) {
...
export function onTransientCheck(token, record, context) {
    var _a, _b, _c;
    var strategy = (_b = (_a = record.metadata) === null || _a === void 0 ? void 0 : _a.onTransientCheck) !== null && _b !== void 0 ? _b : (_c = HookMetadata.get(token)) === null || _c === void 0 ? void 0 : _c.onTransientCheck;
...
export function runCustomFactory(token, record, next, context) {
    var metadata = record.metadata || HookMetadata.get(token);
...
export function runBefore(token, record, context) {
    ...
    if (metadata === null || metadata === void 0 ? void 0 : metadata.beforeListeners) {
        try {
            for (var _b = __values(metadata.beforeListeners), _c = _b.next(); !_c.done; _c = _b.next()) {
...
export function runBeforeAsync(token, record, context) {
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    metadata = record.metadata || HookMetadata.get(token);
                    if (!(metadata === null || metadata === void 0 ? void 0 : metadata.beforeListeners)) return [3 /*break*/, 8];
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 6, 7, 8]);
                    _a = __values(metadata.beforeListeners), _b = _a.next();
                    _d.label = 2;
                case 2:
...
export function runAfter(token, instance, record, context) {
    ...
    if (metadata === null || metadata === void 0 ? void 0 : metadata.afterListeners) {
        try {
            for (var _b = __values(metadata.afterListeners), _c = _b.next(); !_c.done; _c = _b.next()) {
                var listener = _c.value;
    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _d.trys.push([1, 6, 7, 8]);
                    _a = __values(metadata.afterListeners), _b = _a.next();
                    _d.label = 2;
                case 2:
                    if (!!_b.done) return [3 /*break*/, 5];
                    listener = _b.value;
...
export function runError(token, error, record, context) {
    ...
    if (metadata === null || metadata === void 0 ? void 0 : metadata.errorHandlers) {
        try {
            for (var _b = __values(metadata.errorHandlers), _c = _b.next(); !_c.done; _c = _b.next()) {
...
export function onDispose(token, instance, context) {
    var e_6, _a;
    var _b;
    var listeners = (_b = HookMetadata.get(token)) === null || _b === void 0 ? void 0 : _b.disposeListeners;
